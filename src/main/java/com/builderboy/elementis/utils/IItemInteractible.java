...
public interface IItemInteractible {
    ...
    default ActionResultType clientBlockClick(World world, PlayerEntity player, ItemStack held, BlockPos pos, Block blockClicked, boolean isSneaking) { return ActionResultType.PASS; }
    default ActionResultType serverBlockClick(World world, PlayerEntity player, ItemStack held, BlockPos pos, Block blockClicked, boolean isSneaking) { return ActionResultType.PASS; }
}